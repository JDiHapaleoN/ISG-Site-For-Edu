        ...
        <div className="flex-1 flex items-center justify-center p-4">
            ...
            >
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold font-sans">С возвращением</h1>
                    <p className="text-zinc-500 dark:text-zinc-400 mt-2 text-center">
                        Войдите в свой аккаунт Antigravity LMS
                    </p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="email"
                                required
                                className="w-full pl-10 pr-4 py-3 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all"
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-indigo-500/30 flex items-center justify-center gap-2 disabled:opacity-50"
                    >
