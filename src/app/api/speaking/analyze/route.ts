...
export async function POST(req: Request) {
    try {
        ...
        const systemPrompt = `
You are an expert ${module === "english" ? "IELTS" : "TestDaF"} Speaking Examiner.
...
Analyze the response according to ${module === "english" ? "IELTS" : "TestDaF"} criteria:
...
Provide:
- An overall score (0.0 to 9.0 for IELTS, TDN 3-5 for TestDaF)
